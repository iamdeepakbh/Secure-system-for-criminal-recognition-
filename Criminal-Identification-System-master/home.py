...
def getPage1():
    ...
    # Adding Input Fields
    input_fields = ("Name", "Father's Name", "Mother's Name", "Gender", "DOB(yyyy-mm-dd)", "Aadhaar Number",
                    "Crime Type", "Nationality", "Religion", "Area", "Profile Image")
    ip_len = len(input_fields)
    required = [1, 0, 0, 1, 1, 1, 1, 1, 0, 1, 0]
...
btn_frame = tk.Frame(pages[0], bg="#ffffff", pady=30)
btn_frame.pack()
